...
class CustomerResourceTest {
    ...
    @Test
    fun `should crete customer and return 201 status`(){
    //given
    ...
    @Test
    fun`should not save a customer with same CPF and result 409 status`(){
        //given
        customerRepository.save(builderCustomerDto().toEntity())
        val customerDto: CustomerDto = builderCustomerDto()
        val valueString: String = objectMapper.writeValueAsString(customerDto)
        //when
